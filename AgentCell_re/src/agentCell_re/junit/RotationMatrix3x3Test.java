...
import agentCell_re.math.RotationMatrix;
import agentCell_re.math.RotationMatrix3x3;
...
public class RotationMatrix3x3Test extends TestCase {
    ...
    /*
     * Test for void RotationMatrix3x3()
     */
    final public void testRotationMatrix3x3() {
        RotationMatrix r = new RotationMatrix3x3();
        TestCase.assertEquals(true, r.isIdentity());
    }

    /*
     * Test for void RotationMatrix3x3(double, double, double, double, double, double, double, double, double)
     */
    final public void testRotationMatrix3x3doubledoubledoubledoubledoubledoubledoubledoubledouble() {
        RotationMatrix r = new RotationMatrix3x3(1, 0, 0, 0, 1, 0, 0, 0, 1);
        TestCase.assertEquals(true, r.isIdentity());
    }

    /*
     * Test for void RotationMatrix3x3(double[][])
     */
    final public void testRotationMatrix3x3doubleArrayArray() {
        double rr[][] = {
                { 1, 0, 0 },
                { 0, 1, 0 },
                { 0, 0, 1 }
    ...
    /*
     * Test for RotationMatrix setAxisAngleintdouble(int, double)
     */
    final public void testSetAxisAngleintdouble() {
        RotationMatrix r = new RotationMatrix3x3();
    ...
    /*
     * Test for RotationMatrix setAxisAnglevectdouble(Vect, double)
     */
    final public void testSetVectdouble() {
        RotationMatrix r = new RotationMatrix3x3(new Vect3(1, 1, 1),
                (2 * Math.PI) / 3);
        Vect v0 = new Vect3(1, 0, 0); //position before rotation
        Vect v1 = new Vect3(0, 1, 0); //position after rotation
        TestCase.assertEquals(true, r.mult(v0).equals(v1));
    }

    /*
     * Test for RotationMatrix setAxesAnglesintdouledoubledoubledoubledoubledouble(int, double, double, double, double, double, double)
     */
    final public void testSetAxesAnglesintdouledoubledoubledoubledoubledouble() {
        double a0 = Math.PI / 4;
        double a1 = 0.2;
        double a2 = 1.2;
...
//        double s2 = Math.sin(a2);
        RotationMatrix s012 = new RotationMatrix3x3().setAxesAngles(0, a0, a1,
                a2);
        RotationMatrix s021 = new RotationMatrix3x3().setAxesAngles(1, a0, a1,
                a2);
        RotationMatrix s102 = new RotationMatrix3x3().setAxesAngles(2, a0, a1,
                a2);
        RotationMatrix s120 = new RotationMatrix3x3().setAxesAngles(3, a0, a1,
                a2);
        RotationMatrix s201 = new RotationMatrix3x3().setAxesAngles(4, a0, a1,
                a2);
        RotationMatrix s210 = new RotationMatrix3x3().setAxesAngles(5, a0, a1,
                a2);
    ...
    /*
     * Test for RotationMatrix setAxesAnglesintdouledoubledouble(int, double, double, double)
     */
    final public void testSetAxesAnglesintdouledoubledouble() {
        double a0 = Math.PI / 4;
        double a1 = 0.2;
        double a2 = 1.2;
        double c0 = Math.cos(a0);
        ...
        RotationMatrix r012 = new RotationMatrix3x3().setAxesAngles(0, c0, c1,
                c2, s0, s1, s2);
        RotationMatrix r021 = new RotationMatrix3x3().setAxesAngles(1, c0, c1,
                c2, s0, s1, s2);
        RotationMatrix r102 = new RotationMatrix3x3().setAxesAngles(2, c0, c1,
                c2, s0, s1, s2);
        RotationMatrix r120 = new RotationMatrix3x3().setAxesAngles(3, c0, c1,
                c2, s0, s1, s2);
        RotationMatrix r201 = new RotationMatrix3x3().setAxesAngles(4, c0, c1,
                c2, s0, s1, s2);
        RotationMatrix r210 = new RotationMatrix3x3().setAxesAngles(5, c0, c1,
                c2, s0, s1, s2);
