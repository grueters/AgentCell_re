 ...
 * 
 */
public class ConcentrationFieldPulses extends ConcentrationField {
    private Vect start1;
    private Vect end1;
     ...
     * @param level4
     */
    public ConcentrationFieldPulses(String newMolecularType, Vect start1,
        Vect end1, double level1, Vect start2, Vect end2, double level2,
        Vect start3, Vect end3, double level3, Vect start4, Vect end4,
        double level4, Vect start5, Vect end5, double level5) {
    ...
    public double getConcentrationLevelAt(Vect position) {
        if ((position.getElement(2) >= start1.getElement(2)) &&
                (position.getElement(2) < end1.getElement(2))) {
            return level1;
        } else if ((position.getElement(2) >= start2.getElement(2)) &&
                (position.getElement(2) < end2.getElement(2))) {
            return level2;
        } else if ((position.getElement(2) >= start3.getElement(2)) &&
                (position.getElement(2) < end3.getElement(2))) {
            return level3;
        } else if ((position.getElement(2) >= start4.getElement(2)) &&
                (position.getElement(2) < end4.getElement(2))) {
            return level4;
        } else if ((position.getElement(2) >= start5.getElement(2)) &&
                (position.getElement(2) < end5.getElement(2))) {
            return level5;
        } else {
            return 0.0;
        }
